...
$(document).ready(function () {
  ...
  function addProductLine(cartItem) {
    ...
    const newItem = $("<div>");
    newItem.html(`<div class="d-flex justify-content-between align-items-center mb-2 product">
            <h5 class="mb-0" data-amount="20">${cartItem.title}</h5>
  ...
  function setTotalValue(cart) {
    ...
    if (cart === null) {
      ...
      cartTotalContainer.html(`<div class="d-flex justify-content-between align-items-center mb-2 product">
            <h5 class="checkout-total mb-0" data-amount="380" name="orderPrice">TOTAL</h5>
